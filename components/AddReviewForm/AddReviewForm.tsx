...
export default function AddReviewForm({
  ...
  // Formik awaits returned Promise; mutate() would not keep isSubmitting in sync.
      ...
      {({ values, setFieldValue, errors, touched, isSubmitting }) => (
        <Form className={css.form} noValidate>
            ...
            <div className={css.stars} role="group" aria-label="Оцінка">
              {[1, 2, 3, 4, 5].map((star) => {
                ...
                return (
                  ...
                  >
                    <svg className={css.starIcon} viewBox="0 0 32 32" aria-hidden>
                      <use
                        href={
                          filled
          ...
          <div className={css.actions}>
            <button
              type="button"
              className={`btn btn--secondary btn--regular ${css.cancelButton}`}
            ...
            <button
              type="submit"
              className={`btn btn--primary btn--regular ${css.submitButton}`}
